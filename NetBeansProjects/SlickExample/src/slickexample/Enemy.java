...
public class Enemy {
    ...
    Enemy(int a, int b) throws SlickException {
        ...
        SpriteSheet skeletonSS = new SpriteSheet("C:/Users/ddavis2/Desktop/d22_dungeon_crawler/skeletonwspearsprites.png",
    ...
    void setdirection() {
        ...
        if (player.getplayershitboxY() < this.By) {
        ...
        if ((player.getplayershitboxX() > this.Bx)) {

            this.mydirection = Direction.RIGHT;

        }

        if ((player.getplayershitboxX() < this.Bx) && canigoleft()) {
    ...
    void move() throws SlickException {
        ...
        if (this.Bx > player.getplayershitboxX()) {

            this.moveleft();

        } else if (this.Bx < player.getplayershitboxX()) {
        ...
        if (this.By > player.getplayershitboxY()) {

            this.moveup();

        } else if (this.By < player.getplayershitboxY()) {
